...
void	ft_operation_map()
{
	...
	std::cout << "Map find : " << map.find(12)->first << " | " << map.find(1526)->first << std::endl;
	std::cout << "Map find : " << map.count(12) << " | " << map.count(1526) << std::endl;
	std::cout << "Map find : " << map.lower_bound(12)->first << " | " << map.lower_bound(1526)->first << std::endl;
	std::cout << "Map find : " << map.upper_bound(12)->first << " | " << map.upper_bound(1526)->first << std::endl;
	std::cout << "Map find : " << (map.equal_range(12)).first->first << " | " << (map.equal_range(1526)).first->first << std::endl;
}
