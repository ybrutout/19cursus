...
void	ft_cannonical_map()
{
	...
	for(int i = 0; i < 50; i++)
		empty.insert(std::make_pair(i, i+ 1));
	std::map<int, int>		range(empty.begin(), empty.end());
	std::cout << range.size() << " | " << range.empty() << std::endl;
	std::cout << "-----------------------------" << std::endl << std::endl;

	std::cout << "-------Copy-Constructor------" << std::endl;
	std::map<int, int>		copy(range);
	std::cout << copy.size() << " | " << copy.empty() << std::endl;
	std::cout << "-----------------------------" << std::endl << std::endl;

	std::cout << "----------Operator=----------" << std::endl;
	copy.insert(std::make_pair(105, 12));
...
void	ft_modifiers_map()
{
	...
	std::map<int, int>	swap1;
	std::map<int, int>	swap2;

	for(int i = 0; i < 10; i++)
		swap1.insert(std::make_pair(i, i));
	
	for(int i = 0; i < 100; i++)
		swap2.insert(std::make_pair(i, i));
...
void	ft_relationnel_operator_map()
{
	...
	for (int i = 0; i < 100; i++)
		m.insert(std::make_pair(rand() % 100, rand() % 100));
	for (int i = 0; i < 100; i++)
		m2.insert(std::make_pair(rand() % 100, rand() % 100));
	for (int i = 0; i < 100; i++)
		m3.insert(std::make_pair(rand() % 100, rand() % 100));
