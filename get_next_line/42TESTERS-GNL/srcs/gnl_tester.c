...
/*   Updated: 2021/01/11 11:14:34 by ybrutout         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main()
{
	...
	printf("j avant premiere ligne  = %d\n", j);
	while ((i = get_next_line(fd, &line)) > 0)
	{
		printf("|%s\n", line);
		free(line);
	...
	free(line);
	close(fd);
	printf("j apres premiere ligne  = %d\n", j);
	if (!(fd = open("files/42_char", O_RDONLY)))
	{
		printf("\nError in open\n");
		return (0);
	}
	printf("j avant deuxieme ligne  = %d\n", j);
	while ((i = get_next_line(fd, &line)) > 0)
	{
	...
	free(line);
	close(fd);
	printf("j apres deuxieme ligne  = %d\n", j);
	if (!(fd = open("files/43_char", O_RDONLY)))
	{
		printf("\nError in open\n");
		return (0);
	}
	printf("j avant troisieme ligne  = %d\n", j);
	while ((i = get_next_line(fd, &line)) > 0)
	{
		printf("|%s\n", line);
		free(line);
	...
	free(line);
	close(fd);
	printf("j apres troisieme ligne  = %d\n", j);
